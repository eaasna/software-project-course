...
# software-project-course [![build status][1]][2] [![codecov][3]][4]
<!--
...
<!--
    This is the CI badge image:
        ...
        `/eaasna/software-project-course/` - owner/repository
        `CI%20on%20Linux` - name of the workflow as encoded URL (e.g., whitespace = %20)
        `main` - branch to show
        `?style=flat&logo=github` - use a GitHub-style badge
        `&label=software-project-course%20CI` - text on the badge
        `"Open GitHub actions page"` - this text will be shown on hover
-->
[1]: https://img.shields.io/github/actions/workflow/status/eaasna/software-project-course/ci_linux.yml?branch=main&style=flat&logo=github&label=software-project-course%20CI "Open GitHub actions page"
<!--
    This is the CI badge link:
        `https://github.com/eaasna/software-project-course/actions` - actions page of owner/repository
        `?query=branch%3Amain` - only show actions that ran on the mater branch
-->
[2]: https://github.com/eaasna/software-project-course/actions?query=branch%3Amain
<!--
    This is the Codecov badge image:
        Codecov offers badges: https://app.codecov.io/gh/eaasna/software-project-course/settings/badge
        While being logged in into Codecov, navigate to Settings->Badge and copy the markdown badge.
        Copy the image part of the markdown badge here.
    `"Open Codecov page"` - this text will be shown on hover
-->
[3]: https://codecov.io/gh/eaasna/software-project-course/branch/main/graph/badge.svg "Open Codecov page"
<!--
...
-->
[4]: https://codecov.io/gh/eaasna/software-project-course
...
3. **Clone** your repository locally: `git clone git@github.com:eaasna/software-project-course.git`
4. <details><summary>Build and test the app (example) </summary>
    ...
    make               # build the app software-project-course
    make check         # build and run tests
    ./bin/software-project-course # Execute the app (prints a short help page)
    ```
   </details>

## Setting up Codecov (optional)

1. Go to https://codecov.io/gh/eaasna/software-project-course.
2. Sign in with your GitHub account.
3. Go to https://app.codecov.io/gh/eaasna/software-project-course/config/general.<br>
   If the repository cannot be found, go to https://app.codecov.io/gh/eaasna and click `Resync`.<br>
   Then try again.
4. Copy the `Repository Upload Token`.
5. Go to https://github.com/eaasna/software-project-course/settings/secrets/actions.
...
1. Go to https://github.com/eaasna/software-project-course/settings/actions.
...
3. You can go to https://github.com/eaasna/software-project-course/actions/workflows/lint.yml and click `Run workflow` to run linting.
...
2. Add the following lines at the bottom of `src/CMakeLists.txt`
    ...
    target_link_libraries (tutorial01 PRIVATE "software-project-course_lib")
    ```

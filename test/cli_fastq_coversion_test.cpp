...
{
    app_test_result const result = execute_app("software-project-course");
...
{
    app_test_result const result = execute_app("software-project-course", "-v");
...
{
    app_test_result const result = execute_app("software-project-course", data("in.fastq"));
...
{
    app_test_result const result = execute_app("software-project-course", data("in.fastq"), "-v");
...
{
    app_test_result const result = execute_app("software-project-course", data("in.fastq"), "-o", "out.fasta");
...
{
    app_test_result const result = execute_app("software-project-course", data("in.fastq"), "-o", "");
...
{
    app_test_result const result = execute_app("software-project-course", data("in.fastq"), "-o", "does_not_exist/out.fasta");
